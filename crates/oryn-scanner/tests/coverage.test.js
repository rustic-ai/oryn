...
describe('Scanner Coverage Analysis', () => {
        ...
        if (page) {
            ...
            for (const entry of coverage) {
                if (
                    ...
                    (entry.text && entry.text.includes('Oryn Universal Scanner'))
                ) {
    ...
    test('scan command', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'scan' });
    ...
    test('scan with options', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({
                cmd: 'scan',
                include_hidden: true,
                viewport_only: true,
                max_elements: 50
    ...
    test('click command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'click', id: id });
        }, btn.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('click with options', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({
                cmd: 'click',
                id: id,
                button: 'left',
                click_count: 2,
    ...
    test('type command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'type', id: id, text: 'test' });
        }, input.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('type with delay', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'type', id: id, text: 'ab', delay: 10, clear: false });
        }, input.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('clear command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'clear', id: id });
        }, input.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('check/uncheck commands', async () => {
        ...
        await page.evaluate(async (id) => window.Oryn.process({ cmd: 'check', id: id }), checkbox.id);
        await page.evaluate(async (id) => window.Oryn.process({ cmd: 'uncheck', id: id }), checkbox.id);
    ...
    test('scroll command', async () => {
        await page.evaluate(async () => window.Oryn.process({ cmd: 'scroll', direction: 'down', amount: 100 }));
        await page.evaluate(async () => window.Oryn.process({ cmd: 'scroll', direction: 'up' }));
        expect(true).toBe(true);
    });
    ...
    test('focus command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'focus', id: id });
        }, input.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('hover command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'hover', id: id });
        }, btn.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('submit command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'submit', id: id });
        }, email.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('wait_for conditions', async () => {
        ...
        await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'wait_for', condition: 'visible', id: id, timeout: 100 });
        }, btn.id);
    ...
    test('get_text command', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'get_text', selector: 'h1' });
            return res;
        });
        expect(result.status).toBe('ok');
    });
    ...
    test('get_value command', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'get_value', id: id });
        }, checkbox.id);
        expect(result.status).toBe('ok');
    });
    ...
    test('exists command', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'exists', selector: '#btn-1' });
            return res;
        });
    ...
    test('execute command', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'execute', script: 'return 1 + 1' });
            return res;
        });
    ...
    test('version command', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'version' });
            return res;
        });
    ...
    test('iframe scanning - same origin', async () => {
        ...
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'scan', include_iframes: true });
            return res;
        });
    ...
    test('max_elements limit', async () => {
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'scan', max_elements: 5 });
            return res;
        });
    ...
    test('max_elements with iframes', async () => {
        ...
        const result = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'scan', include_iframes: true, max_elements: 10 });
            return res;
        });
    ...
    test('click on hidden element - should fail', async () => {
        ...
        const scan = await page.evaluate(async () => {
            const res = await window.Oryn.process({ cmd: 'scan', include_hidden: true });
            return res;
        });
    ...
    test('click with force bypasses visibility check', async () => {
        ...
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'click', id: id, force: true });
        }, hiddenBtn.id);
    ...
    test('type appends when clear=false', async () => {
        ...
        await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'type', id: id, text: 'Hello' });
        }, input.id);

        // Then append more with clear=false
        const result = await page.evaluate(async (id) => {
            return await window.Oryn.process({ cmd: 'type', id: id, text: ' World', clear: false });
        }, input.id);
        ...
        const value = await page.evaluate(async (id) => {
            const res = await window.Oryn.process({ cmd: 'get_value', id: id });
            return res; // Unpack
        }, input.id);
    ...
    test('error handling - unknown command', async () => {
        const result = await page.evaluate(async () => {
            return await window.Oryn.process({ cmd: 'unknown_cmd' });
        });
        expect(result.status).toBe('error');
    ...
    test('error handling - element not found', async () => {
        const result = await page.evaluate(async () => {
            return await window.Oryn.process({ cmd: 'click', id: 99999 });
        });
        expect(result.status).toBe('error');
