use crate::protocol::{DetectedPatterns, Element, Rect, ScanResult};
...
impl<'a> ResolutionContext<'a> {
    ...
    pub fn to_resolver_context(&self) -> crate::resolver::ResolverContext {
        crate::resolver::ResolverContext::new(self.scan)
    }
}
