use oryn_core::intent::definition::{IntentDefinition, IntentTier, IntentTriggers, Step};
use oryn_core::intent::registry::IntentRegistry;
use oryn_core::intent::schema::{Validatable, ValidationError};
...
fn test_validation_logic() {
    ...
    let valid = IntentDefinition {
        ...
        steps: vec![Step::Checkpoint(
            oryn_core::intent::definition::CheckpointStepWrapper {
