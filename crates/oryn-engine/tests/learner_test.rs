use oryn_engine::learner::LearningConfig;
use oryn_engine::learner::observer::Observer;
use oryn_engine::learner::proposer::Proposer;
use oryn_engine::learner::recognizer::Recognizer;
use oryn_engine::learner::storage::ObservationStorage;
...
fn test_storage_clone_independence() {
    ...
    storage1.record(oryn_engine::learner::SessionLog {
...
fn test_proposer_valid_pattern() {
    let proposer = Proposer::new();
    let pattern = oryn_engine::learner::recognizer::Pattern {
        steps: vec![
