...
- `.github/workflows/ci-e2e-quick.yml` executes this suite through `./scripts/run-e2e-tests.sh --quick` (oryn-h path).
- `.github/workflows/nightly-full-e2e.yml` runs the same script set across backend variants.
