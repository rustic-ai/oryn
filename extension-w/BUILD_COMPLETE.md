...
### Documentation
See `docs/EXTENSION-PACKING-GUIDE.md` for complete distribution guide.
...
- **Implementation Guide**: `docs/RALPH-AGENT-IMPLEMENTATION-COMPLETE.md`
- **Original Plan**: `docs/RALPH-AGENT-INTEGRATION.md`
- **LLM Selection**: `docs/LLM-SELECTION-UI.md`
- **WASM Adapters**: `docs/WASM-LLM-ADAPTERS.md`
