...
- PR/main Docker smoke coverage is run by `.github/workflows/ci-e2e-quick.yml`.
- Full backend matrix Docker coverage is run by `.github/workflows/nightly-full-e2e.yml`.
